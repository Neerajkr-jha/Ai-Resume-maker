  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type="text" placeholder="Enter a Skill (e.g., Javascript, DBMS)" className='text-sm flex-1 px-3 py-2' onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-500'><strong>Tip:</strong>Add 8-12 relevant Skills (programming languages, tools) and soft skills (leadership,communication)</p>
        </div>
    </div>
  )
}
