...
function EducationForm({ data, onChange }) {
  ...
  return (
      ...
      <div className='flex items-center justify-between'>
            ...
            <div>
                <h2 className='flex items-center gap-2 text-lg font-semibold text-gray-900'>Education</h2>
                <p className='text-sm text-gray-600'>Add your Education</p>
            </div>
                ...
                {data.map((education,index)=>(
                    <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                            ...
                            <input type="text" value={education.degree || ""} onChange={(e)=>updateEducation(index,"degree",e.target.value)} placeholder="Degree(e.g.,Bachelor's,Mater's)" className="px-3 py-2 text-sm" />
